    ...
    if (userOrders.length > 0) {
      ...
      if (orderIdToShow) {
        ...
        if (orderToShow) {
          ...
          console.log('OrderHistory: Order not found, will retry after delay...');
          ...
          setTimeout(() => {
            ...
            if (retryOrderId) {
              ...
              if (retryOrder) {
                console.log('OrderHistory: Found order on retry, opening receipt');
                setSelectedOrder(retryOrder);
                sessionStorage.removeItem('showReceiptForOrder');
              } else {
                console.log('OrderHistory: Order not found after retry');
                sessionStorage.removeItem('showReceiptForOrder');
              }
            }
      ...
      if (pendingReceiptOrderId) {
        ...
        if (orderToShow) {
          console.log('OrderHistory: Opening receipt for pending order');
          setSelectedOrder(orderToShow);
