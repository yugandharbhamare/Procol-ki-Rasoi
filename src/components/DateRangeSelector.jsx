    ...
    <div className={`bg-white rounded-lg shadow p-3 sm:p-4 ${className}`}>
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        ...
        <button
          ...
          className="w-full sm:w-auto bg-green-600 text-white px-4 py-2 h-10 rounded-lg hover:bg-green-700 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center gap-2 font-medium transition-colors text-sm"
        >
